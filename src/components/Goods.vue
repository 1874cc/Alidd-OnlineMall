<template>
  <div class="container">
    <div class="left">
      <div class="actor">
        <img :src="actorC">
        <div ref="animPart" class="anim-part" :class="{'anim-cart': isCart, 'anim-order': isOrder ,'anim-collection':isCollection}">
          <img :src="actorC">
        </div>
      </div>
      <ul class="thumbnail-list">
        <li class="thumbnail-item" v-for="(thumbnail, index) in thumbnails" :key="index" @mouseover="toggleActor(index)">
    ...
    <div class="right">
      ...
      <div class="banner-operate">
        ...
        <br><br/>
        <span class="btn-operate btn-collection" @click="addInCollection">
  ...
  export default {
    ...
    methods: {
      ...
      addInCollection() {
        ...
        this.collection.push(this.result)
        this.setStore()
      }
    }
  }
...
<style scoped>
  ...
  .anim-collection {
    animation-duration: 500ms;
    animation-name: addInCollection;
    animation-timing-function: ease-in-out;
  }
